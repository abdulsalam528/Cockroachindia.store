...
import { ArrowLeft, Star, ShieldCheck, X, Check, AlertTriangle } from 'lucide-react';
        ...
        <div className="flex flex-col gap-4 max-w-md lg:max-w-none mx-auto w-full">
          ...
          >
            <Image
              ...
              alt={getProductAltText(product, selectedColor)}
              fill
          ...
          <div className="flex flex-col gap-4">
            <div className="flex justify-between items-start gap-4">
              <div>
                ...
                <h1 className="font-display text-3xl sm:text-4xl uppercase font-black mt-2 leading-none">
                  {product.name}
                </h1>
              </div>
