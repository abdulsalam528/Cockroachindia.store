...
export default function RootLayout({ children }) {
  return (
    <html
      lang="en"
      className={`${bebasNeue.variable} ${robotoMono.variable} h-full`}
      ...
      <body className="min-h-full bg-[#EAE5D9] text-[#000000] font-mono flex flex-col antialiased selection:bg-[#C2410C] selection:text-white">
        <AuthProvider>
          ...
          <a
            ...
            className="fixed bottom-6 right-4 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] shadow-lg hover:scale-110 transition-transform duration-200"
